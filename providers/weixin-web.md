...
* The listener that you add for this provider is `'SocialiteProviders\\WeixinWeb\\WeixinWebExtendSocialite@handle',`.
...
return Socialite::with('weixinweb')->stateless(false)->redirect();
