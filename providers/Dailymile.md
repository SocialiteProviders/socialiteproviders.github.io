...
* The listener that you add for this provider is `'SocialiteProviders\\Dailymile\\DailymileExtendSocialite@handle',`.
...
protected $listen = [
    \SocialiteProviders\Manager\SocialiteWasCalled::class => [
        ...
        'SocialiteProviders\\Dailymile\\DailymileExtendSocialite@handle',
    ],
];
```
...
return Socialite::with('Dailymile')->stateless(false)->redirect();

// to use stateless
return Socialite::with('Dailymile')->stateless()->redirect();
```
...
return Socialite::with('Dailymile')->setConfig($config)->redirect();
```
...
```php
$user = Socialite::driver('Dailymile')->user();
