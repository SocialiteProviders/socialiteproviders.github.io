...
* The listener that you add for this provider is `'SocialiteProviders\\Graph\\GraphExtendSocialite@handle',`.
...
return Socialite::with('graph')->stateless(false)->redirect();
