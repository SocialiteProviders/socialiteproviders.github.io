...
* The listener that you add for this provider is `'SocialiteProviders\\Everyplay\\EveryplayExtendSocialite@handle',`.
...
protected $listen = [
    \SocialiteProviders\Manager\SocialiteWasCalled::class => [
        ...
        'SocialiteProviders\\Everyplay\\EveryplayExtendSocialite@handle',
    ],
];
```
...
return Socialite::with('Everyplay')->stateless(false)->redirect();

// to use stateless
return Socialite::with('Everyplay')->stateless()->redirect();
```
...
return Socialite::with('Everyplay')->setConfig($config)->redirect();
```
...
```php
$user = Socialite::driver('Everyplay')->user();
