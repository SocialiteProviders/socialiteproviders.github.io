...
* The listener that you add for this provider is `'SocialiteProviders\\Weibo\\WeiboExtendSocialite@handle',`.
...
return Socialite::with('Weibo')->stateless(false)->redirect();
